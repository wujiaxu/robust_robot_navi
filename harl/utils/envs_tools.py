...
def make_train_env(env_name, seed, n_threads, env_args,human_policy_class=None):
    ...
    if n_threads == 1:
        ...
        return ShareSubprocVecEnv([get_env_fn(i) for i in range(n_threads)],human_policy_class=human_policy_class)


def make_eval_env(env_name, seed, n_threads, env_args,human_policy_class=None):
...
def get_num_agents(env, env_args, envs):
    ...
    # elif env == "crowd_env":
    #     return envs.n_agents
    # elif env == "crowd_env_vis":
    #     return envs.n_agents
    elif "crowd_env" in env:
        return envs.n_agents
