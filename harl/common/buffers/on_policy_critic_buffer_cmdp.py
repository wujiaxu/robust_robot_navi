...
class OnPolicyCriticBufferCMDP:
    ...
    def recurrent_generator_critic(self, critic_num_mini_batch, data_chunk_length):
        ...
        aux_value_preds = _ma_cast(self.aux_value_preds[:-1])
        aux_returns = _ma_cast(self.aux_returns[:-1])
        ...
        for indices in sampler:
            ...
            aux_value_preds_batch = _flatten(L, N, aux_value_preds_batch)
            aux_return_batch = _flatten(L, N, aux_return_batch)
