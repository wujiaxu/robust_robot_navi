...
from harl.runners.on_policy_dec_runner import OnPolicyDecRunner
...
RUNNER_REGISTRY = {
    ...
    "robot_crowd_happo":OnPolicyHARunner,
    "robot_crowd_ppo": OnPolicyDecRunner,
    "robot_crowd_happo_woD":OnPolicyHARunner,
