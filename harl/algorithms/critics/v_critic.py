...
from harl.models.value_function_models.custom_v_net import CustomVNet,CustomDoubleVNet
...
class VCritic:
    ...
    def __init__(self, args, centralized, device=torch.device("cpu")):
        ...
        self.critic = CustomVNet(args, centralized, self.device)
    ...
    def update(self, sample, value_normalizer=None):
        ...
        # print(share_obs_batch.shape,rnn_states_critic_batch.shape,
        #       value_preds_batch.shape,return_batch.shape,masks_batch.shape)
...
class DoubleVCritic:
    ...
    def __init__(self, args, centralized, device=torch.device("cpu")):
        ...
        self.critic = CustomDoubleVNet(args, centralized, self.device)
