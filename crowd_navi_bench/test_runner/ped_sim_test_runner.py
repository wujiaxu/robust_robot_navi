...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", type=str, default="ai_crowdsim_5p_rvs_sp_room361", help="Experiment name."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="/home/dl/wu_ws/HARL/results/crowd_env/crowd_navi/robot_crowd_happo/ped_sim_base/happo_5p_rvs_sp_room361",
