...
class OnPolicyTestRunner:
    ...
    def __init__(self, args, algo_args, env_args,
        ...
        self.data_recorder = DataRecorder(100,self.log_dir)
    def run(self):
        ...
        if self.manual_expand_dims:
            ...
            for e in range(self.algo_args["render"]["render_episodes"]):
                ...
                while True:
                    ...
                    self.data_recorder.record_step(eval_rnn_states,eval_actions,eval_rewards)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", type=str, default="train_on_ai_090_4p_3c_rvs_room361_vs_c090_happo_5p_3c_rvs_room361_data", help="Experiment name."
    )
    parser.add_argument(
        "--test_episode", type=int, default=1500, help="Experiment iteration."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--human_model_dir",
        type=str,
        default="/home/dl/wu_ws/HARL/results_seed_1/crowd_env/crowd_navi/robot_crowd_happo/c0.90_happo_5p_3c_rvs_room361/seed-00001-2024-09-27-10-55-57",
        help="If set, load existing experiment config file instead of reading from yaml config file.",
    )
