...
class OnPolicyTestRunner:
    ...
    def __init__(self, args, algo_args, env_args):
        ...
        self.env_args["max_episode_length"] = 300
        ...
        if self.manual_expand_dims:
            ...
            for e in range(self.algo_args["render"]["render_episodes"]):
                ...
                while True:
                    ...
                    eval_actions_collector.append(self.rec_policy.predict(0))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", type=str, default="sfm_vs_ORCA_crowd", help="Experiment name."
    )
    parser.add_argument(
        "--test_episode", type=int, default=100, help="Experiment iteration."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="/home/dl/wu_ws/robust_robot_navi/crowd_navi_bench/results/crowd_env/crowd_navi/robot_crowd_happo/train_on_sfm_crowd/seed-00001-2024-09-28-20-00-11",
