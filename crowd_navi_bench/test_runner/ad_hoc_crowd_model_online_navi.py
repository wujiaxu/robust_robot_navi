...
class OnPolicyTestRunner:
    ...
    def __init__(self, args, algo_args, env_args):
        ...
        self.vae.load_model("/home/dl/wu_ws/HARL/crowd_navi_bench/density_model/vae_model_4399.pth")
        self.vae.eval()
    ...
    def render(self):
        ...
        if self.manual_expand_dims:
            ...
            for e in range(self.algo_args["render"]["render_episodes"]):
                ...
                # self.envs.set_agent_size(1,0.7)
                # self.envs.set_agent_size(2,0.5)
                for human_id in self.envs.humans:
                    self.envs.set_agent_v_pref(human_id,2.1)
                ...
                while True:
                    ...
                    log_prob = self.vae.estimate_log_probability(np.concatenate([eval_obs[:,0,:726],np.expand_dims(eval_actions_collector[0],axis=0)],axis=-1))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", type=str, default="train_on_ai_090_4p_3c_rvs_room361_vs_SFM_crowd", help="Experiment name."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="/home/dl/wu_ws/HARL/crowd_navi_bench/results/crowd_env/crowd_navi/robot_crowd_happo/train_on_ai_090_4p_3c_rvs_room361/seed-00001-2024-09-29-17-59-46",
