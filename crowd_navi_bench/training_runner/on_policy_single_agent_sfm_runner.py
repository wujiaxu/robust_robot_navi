...
class OnPolicySFMCrowdRunner:
    ...
    def __init__(self, args, algo_args, env_args):
        ...
        if args["env"] == "crowd_env_vis" or args["env"] == "crowd_env_vis_ablation_2":
            algo_args["algo"]["use_vis_aware"] = True
            # self.use_discriminator = False
            self.use_vis_aware = True
            print("use vis aware observation")
    ...
    def after_update(self):
        ...
        """
        self.actor_buffer[0].after_update()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--exp_name", type=str, default="train_on_sfm_crowd", help="Experiment name."
    )
    parser.add_argument(
        "--load_config",
        type=str,
    ...
    runner = OnPolicySFMCrowdRunner(args, algo_args, env_args)
    runner.run()
    runner.close()