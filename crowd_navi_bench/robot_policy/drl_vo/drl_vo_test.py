...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="/home/dl/wu_ws/robust_robot_navi/crowd_navi_bench/robot_policy/drl_vo/model/proposed_4p_room361",
        help="If set, load existing experiment config file instead of reading from yaml config file.",
    )
    ...
    human_model_dir = find_seed_directories(
                            ...
                            seed=1)[0] 
    exp_name = robot_model_dir.split("/")[-1]+"_vs_"+human_model_dir.split("/")[-2]+"_"+args["exp_name"] #"proposed_4p_room361_5"
    print(exp_name)
    # load model
